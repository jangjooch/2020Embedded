...
void button_up_al(){
  ...
  else if(AL_SelectNum == 1){
    al_hour1++;
    if( (al_hour10 == 1) && (al_hour1 > 2) ){
      al_hour1 = 0;
    }
    else if(al_hour1 > 9){
      al_hour1 = 0;
  ...
  else if(AL_SelectNum == 2){
    al_min10++;
    if(al_min10 > 5){
      al_min10 = 0;
    }
  }
  else if(AL_SelectNum == 3){
    al_min1++;
    if(al_min1 > 9){
      al_min1 = 0;
    }
...
bool AL_checking(){
  if(al_min10 == min10Num){
    if(al_min1 == min1Num){
      if(al_hour10 == hour10Num){
        if(al_hour1 == hour1Num){
          return true;
        }
      }
    }
